...
/**
 * Send a command to Yeelight bridge and call callback function with data received
 * @param command   The text string command to send
 * @param ip        IP address of the Yeelight bridge
 * @param cb        callback function for handling data when received
 */
exports.sendCommand = function (command, ip, cb) {

    console.log("Sending: " + command);

    // make TCP socket connection to Yeelight bridge on port 10003 at the IP
